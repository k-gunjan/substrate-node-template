...
impl<T: Config> Pallet<T> {
  ...
  #[pallet::weight(0)]
  pub fn upload_file(origin: OriginFor<T>, cid: T::Hash, file_link: String, allow_download: bool, file_type: String, cost: u32,  file_size: u32,) -> DispatchResult {
